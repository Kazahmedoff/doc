...
<img src="./media/image20.png" width="533" height="278" />
...
Полезно также знать, что фильтр используется для приближённого вычисления градиента функции интенсивности пикселей. Применение оператора G<sub>x</sub> позволяет определить приближённое значение первой частной производной изменения интенсивности в горизонтальном направлении, G<sub>y</sub> – в вертикальном. Пример применения данного фильтра на КТ представлен на рисунке 18.  

<img src="./media/image24.png" width="640" height="336" />

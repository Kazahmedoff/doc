...
![Рис. 12] (https://habrastorage.org/getpro/habr/post_images/be3/833/80e/be383380e8906ea37e3815c05dbfeaf3.png "Матрица свёртки")  
 Рисунок 12  
 
 Важно отметить, что сумма элементов матрицы равна 1, поэтому и коэффициент нормироания так же равен 1. Сила размытия изображения зависит от размера матрицы свёртки (см. рисунок 13).  
 
 ![Рис. 13] (https://habrastorage.org/getpro/habr/post_images/0be/1b7/f45/0be1b7f45cc0f54ff0f79c90fac4114b.png "Размытие изображения")  
 Рисунок 13  
 ...
 ![Рис. 14] (https://habrastorage.org/getpro/habr/post_images/d03/7d9/16c/d037d916ce82754636b3154fd9b7d6bb.png "Решение проблемы")  
 Рисунок 14 
